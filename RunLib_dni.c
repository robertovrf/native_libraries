...
{TYPE_DATA, 0, 8, (DanaTypeField*) VC_fields, 1};
...
static const DanaType object_RunLib_functions_spec[] = {
...
{(DanaType*) &object_RunLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_RunLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_RunLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_RunLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_RunLib_functions_spec[4], "execute", 7}};
static const DanaType RunLib_object_spec[] = {
{TYPE_DATA, 0, 0, (DanaTypeField*) intf_functions_def, 5},
{TYPE_DATA, 0, 0, NULL, 0},
{TYPE_DATA, 0, 0, NULL, 0}
};
static const DanaTypeField intf_def[] = {
{(DanaType*) &RunLib_object_spec[0], ".functions", 10},
{(DanaType*) &RunLib_object_spec[1], ".events", 7},
{(DanaType*) &RunLib_object_spec[2], ".state", 6},
};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_RunLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_RunLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_RunLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_RunLib_functions_spec[3];
...
((VFrameHeader*) op_execute_thread_spec) -> localsDef = (size_t) &object_RunLib_functions_spec[4];
