...
static const DanaType object_MySQLLib_spec[] = {
...
{(DanaType*) &object_MySQLLib_spec[0], "clone", 5},
{(DanaType*) &object_MySQLLib_spec[1], "equals", 6},
{(DanaType*) &object_MySQLLib_spec[2], "toString", 8},
{(DanaType*) &object_MySQLLib_spec[3], "getID", 5},
{(DanaType*) &object_MySQLLib_spec[4], "connect", 7},
{(DanaType*) &object_MySQLLib_spec[5], "executeQuery", 12},
{(DanaType*) &object_MySQLLib_spec[6], "fetchRow", 8},
{(DanaType*) &object_MySQLLib_spec[7], "numFields", 9},
{(DanaType*) &object_MySQLLib_spec[8], "getField", 8},
{(DanaType*) &object_MySQLLib_spec[9], "getFieldName", 12},
{(DanaType*) &object_MySQLLib_spec[10], "close", 5}};
...
static DanaType libType = {TYPE_OBJECT, 0, 0, (DanaTypeField*) intf_def, 11};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[3];
...
((VFrameHeader*) op_connect_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[4];
...
((VFrameHeader*) op_executeQuery_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[5];
...
((VFrameHeader*) op_fetchRow_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[6];
...
((VFrameHeader*) op_numFields_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[7];
...
((VFrameHeader*) op_getField_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[8];
...
((VFrameHeader*) op_getFieldName_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[9];
...
((VFrameHeader*) op_close_thread_spec) -> localsDef = (size_t) &object_MySQLLib_spec[10];
