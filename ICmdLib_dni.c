...
static const DanaTypeField function_ICmdLib_clone_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_ICmdLib_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_ICmdLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_ICmdLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_ICmdLib_getLine_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaType object_ICmdLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_ICmdLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_ICmdLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_ICmdLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_ICmdLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_ICmdLib_getLine_fields, 1}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_ICmdLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_ICmdLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_ICmdLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_ICmdLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_ICmdLib_functions_spec[4], "getLine", 7}};
static const DanaType ICmdLib_object_spec[] = {
{TYPE_DATA, 0, 0, (DanaTypeField*) intf_functions_def, 5},
{TYPE_DATA, 0, 0, NULL, 0},
{TYPE_DATA, 0, 0, NULL, 0}
};
static const DanaTypeField intf_def[] = {
{(DanaType*) &ICmdLib_object_spec[0], ".functions", 10},
{(DanaType*) &ICmdLib_object_spec[1], ".events", 7},
{(DanaType*) &ICmdLib_object_spec[2], ".state", 6},
};
...
static InterfaceDetails ids[] = {{"ICmdLib", 7, &libType}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_ICmdLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_ICmdLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_ICmdLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_ICmdLib_functions_spec[3];
((VFrameHeader*) op_getID_thread_spec) -> functionName = "getID";
((VFrameHeader*) op_getLine_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + 40;
((VFrameHeader*) op_getLine_thread_spec) -> formalParamsCount = 0;
((VFrameHeader*) op_getLine_thread_spec) -> localsDef = (size_t) &object_ICmdLib_functions_spec[4];
