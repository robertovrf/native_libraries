...
{TYPE_DATA, 0, sizeof(VVarLivePTR), (DanaTypeField*) DateTime_fields, 7};
...
static const DanaType object_ICalLib_spec[] = {
...
{(DanaType*) &object_ICalLib_spec[0], "clone", 5},
{(DanaType*) &object_ICalLib_spec[1], "equals", 6},
{(DanaType*) &object_ICalLib_spec[2], "toString", 8},
{(DanaType*) &object_ICalLib_spec[3], "getID", 5},
{(DanaType*) &object_ICalLib_spec[4], "getLocalTime", 12}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_ICalLib_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_ICalLib_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_ICalLib_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_ICalLib_spec[3];
...
((VFrameHeader*) op_getLocalTime_thread_spec) -> localsDef = (size_t) &object_ICalLib_spec[4];
