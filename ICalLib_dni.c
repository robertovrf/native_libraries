...
static const DanaType function_ICalLib_getID_def[] = {
{TYPE_ARRAY, X_POINTER, 0, sizeof(VVarLivePTR), sizeof(VVarLivePTR), 0, {(unsigned char*) &array_char_def}}};
static const StructuredType function_ICalLib_getID_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_ICalLib_getID_def, NULL, 0, sizeof(function_ICalLib_getID_def)}, 0};
...
{{NULL, NULL, 0, 0}, {(unsigned char*) function_ICalLib_getID_def, NULL, 0, sizeof(function_ICalLib_getID_def)}, 0},
...
((VFrameHeader*) op_getLocalTime_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + getLocalTimeLocalsDef.size;
((VFrameHeader*) op_getLocalTime_thread_spec) -> formalParamsCount = (getLocalTimeLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((VFrameHeader*) op_getLocalTime_thread_spec) -> localsDef = (size_t) &getLocalTimeLocalsDef;
