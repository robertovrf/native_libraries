...
((VFrameHeader*) op_sleep_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(VVarR) + sleepLocalsDef.size;
((VFrameHeader*) op_sleep_thread_spec) -> formalParamsCount = (sleepLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((VFrameHeader*) op_sleep_thread_spec) -> localsDef = (size_t) &sleepLocalsDef;
