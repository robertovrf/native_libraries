...
static const DanaType object_Timer_spec[] = {
...
{(DanaType*) &object_Timer_spec[0], "clone", 5},
{(DanaType*) &object_Timer_spec[1], "equals", 6},
{(DanaType*) &object_Timer_spec[2], "toString", 8},
{(DanaType*) &object_Timer_spec[3], "getID", 5},
{(DanaType*) &object_Timer_spec[4], "sleep", 5}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_Timer_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_Timer_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_Timer_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_Timer_spec[3];
...
((VFrameHeader*) op_sleep_thread_spec) -> localsDef = (size_t) &object_Timer_spec[4];
