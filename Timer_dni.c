...
static const DanaType function_Timer_clone_def[] = {
{TYPE_LITERAL, X_FLAT, 0, 1, 1, 0},
{TYPE_OBJECT, X_POINTER, 1, sizeof(VVarLivePTR), sizeof(VVarLivePTR), 0, {(unsigned char*) &object_Object_def}}};
static const StructuredType function_Timer_clone_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_clone_def, NULL, 0, sizeof(function_Timer_clone_def)}, 0};
static const DanaType function_Timer_equals_def[] = {
{TYPE_LITERAL, X_FLAT, 0, 1, 1, 0},
{TYPE_OBJECT, X_POINTER, 1, sizeof(VVarLivePTR), sizeof(VVarLivePTR), 0, {(unsigned char*) &object_Object_def}}};
static const StructuredType function_Timer_equals_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_equals_def, NULL, 0, sizeof(function_Timer_equals_def)}, 0};
static const DanaType function_Timer_toString_def[] = {
{TYPE_ARRAY, X_POINTER, 0, sizeof(VVarLivePTR), sizeof(VVarLivePTR), 0, {(unsigned char*) &array_char_def}}};
static const StructuredType function_Timer_toString_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_toString_def, NULL, 0, sizeof(function_Timer_toString_def)}, 0};
static const DanaType function_Timer_getID_def[] = {
{TYPE_ARRAY, X_POINTER, 0, sizeof(VVarLivePTR), sizeof(VVarLivePTR), 0, {(unsigned char*) &array_char_def}}};
static const StructuredType function_Timer_getID_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_getID_def, NULL, 0, sizeof(function_Timer_getID_def)}, 0};
static const DanaType function_Timer_sleep_def[] = {
{TYPE_LITERAL, X_FLAT, 0, 0, 0, 0},
{TYPE_LITERAL, X_FLAT, 0, sizeof(size_t), sizeof(size_t), 0}};
static const StructuredType function_Timer_sleep_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_sleep_def, NULL, 0, sizeof(function_Timer_sleep_def)}, 0};
static const StructuredFunctionType intf_fnc[] = {
{{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_clone_def, NULL, 0, sizeof(function_Timer_clone_def)}, 0},
{{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_equals_def, NULL, 0, sizeof(function_Timer_equals_def)}, 0},
{{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_toString_def, NULL, 0, sizeof(function_Timer_toString_def)}, 0},
{{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_getID_def, NULL, 0, sizeof(function_Timer_getID_def)}, 0},
{{NULL, NULL, 0, 0}, {(unsigned char*) function_Timer_sleep_def, NULL, 0, sizeof(function_Timer_sleep_def)}, 0}};
...
static StructuredInterfaceType ILib = {{(unsigned char*) "Timer", NULL, 0, 5}, {(unsigned char*) intf_def, NULL, 0, sizeof(intf_def)}, 0};
...
static DanaType sleepLocalsSpec[] = {
{TYPE_LITERAL, X_FLAT, 0, 0, 0, 0},
{TYPE_LITERAL, X_FLAT, 0, sizeof(size_t), sizeof(size_t), 0}};
static StructuredType sleepLocalsDef = {{}, {(unsigned char*) sleepLocalsSpec, NULL, 0, sizeof(sleepLocalsSpec)}, 0};
...
populateOffsets(sleepLocalsSpec, sizeof(sleepLocalsSpec) / sizeof(DanaType), &sleepLocalsDef);
...
((VFrameHeader*) op_sleep_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + sleepLocalsDef.size;
((VFrameHeader*) op_sleep_thread_spec) -> formalParamsCount = (sleepLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_sleep_thread_spec)[1])[0] = (size_t) &sleepLocalsDef;
