...
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_IOTCPLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_IOTCPLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_IOTCPLib_connect_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0},{(DanaType*) &char_array_def, NULL, 0, 0, 8},
{(DanaType*) &int_def, NULL, 0, 0, 48}};
static const DanaTypeField function_IOTCPLib_disconnect_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_IOTCPLib_send_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 8},
{(DanaType*) &byte_array_def, NULL, 0, 0, 16}};
static const DanaTypeField function_IOTCPLib_recv_fields[] = {
{(DanaType*) &byte_array_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 40},
{(DanaType*) &int_def, NULL, 0, 0, 48}};
static const DanaTypeField function_IOTCPLib_accept_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 8}};
static const DanaTypeField function_IOTCPLib_bind_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0},{(DanaType*) &char_array_def, NULL, 0, 0, 8},
{(DanaType*) &int_def, NULL, 0, 0, 48}};
static const DanaTypeField function_IOTCPLib_unbind_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaTypeField function_IOTCPLib_getLocalAddress_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0},
{(DanaType*) &NetworkEndpoint_def, NULL, 0, 0, 8}};
static const DanaTypeField function_IOTCPLib_getRemoteAddress_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0},
{(DanaType*) &NetworkEndpoint_def, NULL, 0, 0, 8}};
static const DanaType object_IOTCPLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_IOTCPLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_IOTCPLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_IOTCPLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_IOTCPLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 56, (DanaTypeField*) &function_IOTCPLib_connect_fields, 3},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_IOTCPLib_disconnect_fields, 2},
{TYPE_FUNCTION, 0, 56, (DanaTypeField*) &function_IOTCPLib_send_fields, 3},
{TYPE_FUNCTION, 0, 56, (DanaTypeField*) &function_IOTCPLib_recv_fields, 3},
{TYPE_FUNCTION, 0, 16, (DanaTypeField*) &function_IOTCPLib_accept_fields, 2},
{TYPE_FUNCTION, 0, 56, (DanaTypeField*) &function_IOTCPLib_bind_fields, 3},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_IOTCPLib_unbind_fields, 2},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_IOTCPLib_getLocalAddress_fields, 3},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_IOTCPLib_getRemoteAddress_fields, 3}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_IOTCPLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_IOTCPLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_IOTCPLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_IOTCPLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_IOTCPLib_functions_spec[4], "connect", 7},
{(DanaType*) &object_IOTCPLib_functions_spec[5], "disconnect", 10},
{(DanaType*) &object_IOTCPLib_functions_spec[6], "send", 4},
{(DanaType*) &object_IOTCPLib_functions_spec[7], "recv", 4},
{(DanaType*) &object_IOTCPLib_functions_spec[8], "accept", 6},
{(DanaType*) &object_IOTCPLib_functions_spec[9], "bind", 4},
{(DanaType*) &object_IOTCPLib_functions_spec[10], "unbind", 6},
{(DanaType*) &object_IOTCPLib_functions_spec[11], "getLocalAddress", 15},
{(DanaType*) &object_IOTCPLib_functions_spec[12], "getRemoteAddress", 16}};
static const DanaType IOTCPLib_object_spec[] = {
{TYPE_DATA, 0, 0, (DanaTypeField*) intf_functions_def, 13},
{TYPE_DATA, 0, 0, NULL, 0},
{TYPE_DATA, 0, 0, NULL, 0}
};
static const DanaTypeField intf_def[] = {
{(DanaType*) &IOTCPLib_object_spec[0], ".functions", 10},
{(DanaType*) &IOTCPLib_object_spec[1], ".events", 7},
{(DanaType*) &IOTCPLib_object_spec[2], ".state", 6},
};
...
static InterfaceDetails ids[] = {{"IOTCPLib", 8, &libType}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[3];
...
((VFrameHeader*) op_connect_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[4];
...
((VFrameHeader*) op_disconnect_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[5];
...
((VFrameHeader*) op_send_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[6];
...
((VFrameHeader*) op_recv_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[7];
...
((VFrameHeader*) op_accept_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[8];
...
((VFrameHeader*) op_bind_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[9];
...
((VFrameHeader*) op_unbind_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[10];
...
((VFrameHeader*) op_getLocalAddress_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[11];
...
((VFrameHeader*) op_getRemoteAddress_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_functions_spec[12];
