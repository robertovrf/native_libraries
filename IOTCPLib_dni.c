...
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0},
{(DanaType*) &NetworkEndpoint_def, NULL, 0, 0, 8}};
static const DanaType object_IOTCPLib_spec[] = {
...
{(DanaType*) &object_IOTCPLib_spec[0], "clone", 5},
{(DanaType*) &object_IOTCPLib_spec[1], "equals", 6},
{(DanaType*) &object_IOTCPLib_spec[2], "toString", 8},
{(DanaType*) &object_IOTCPLib_spec[3], "getID", 5},
{(DanaType*) &object_IOTCPLib_spec[4], "connect", 7},
{(DanaType*) &object_IOTCPLib_spec[5], "disconnect", 10},
{(DanaType*) &object_IOTCPLib_spec[6], "send", 4},
{(DanaType*) &object_IOTCPLib_spec[7], "recv", 4},
{(DanaType*) &object_IOTCPLib_spec[8], "accept", 6},
{(DanaType*) &object_IOTCPLib_spec[9], "bind", 4},
{(DanaType*) &object_IOTCPLib_spec[10], "unbind", 6},
{(DanaType*) &object_IOTCPLib_spec[11], "getLocalAddress", 15},
{(DanaType*) &object_IOTCPLib_spec[12], "getRemoteAddress", 16}};
...
static DanaType libType = {TYPE_OBJECT, 0, 0, (DanaTypeField*) intf_def, 13};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[3];
...
((VFrameHeader*) op_connect_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[4];
...
((VFrameHeader*) op_disconnect_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[5];
...
((VFrameHeader*) op_send_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[6];
...
((VFrameHeader*) op_recv_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[7];
...
((VFrameHeader*) op_accept_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[8];
...
((VFrameHeader*) op_bind_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[9];
...
((VFrameHeader*) op_unbind_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[10];
...
((VFrameHeader*) op_getLocalAddress_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[11];
...
((VFrameHeader*) op_getRemoteAddress_thread_spec) -> localsDef = (size_t) &object_IOTCPLib_spec[12];
