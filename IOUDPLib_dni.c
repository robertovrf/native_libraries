...
static const DanaType object_IOUDPLib_spec[] = {
...
{(DanaType*) &object_IOUDPLib_spec[0], "clone", 5},
{(DanaType*) &object_IOUDPLib_spec[1], "equals", 6},
{(DanaType*) &object_IOUDPLib_spec[2], "toString", 8},
{(DanaType*) &object_IOUDPLib_spec[3], "getID", 5},
{(DanaType*) &object_IOUDPLib_spec[4], "send", 4},
{(DanaType*) &object_IOUDPLib_spec[5], "recv", 4},
{(DanaType*) &object_IOUDPLib_spec[6], "bind", 4},
{(DanaType*) &object_IOUDPLib_spec[7], "unbind", 6}};
...
static DanaType libType = {TYPE_OBJECT, 0, 0, (DanaTypeField*) intf_def, 8};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[3];
...
((VFrameHeader*) op_send_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[4];
...
((VFrameHeader*) op_recv_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[5];
...
((VFrameHeader*) op_bind_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[6];
...
((VFrameHeader*) op_unbind_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_spec[7];
