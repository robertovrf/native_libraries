...
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_IOUDPLib_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_IOUDPLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_IOUDPLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_IOUDPLib_send_fields[] = {
...
static const DanaTypeField function_IOUDPLib_recv_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 1},
{(DanaType*) &Datagram_def, NULL, 0, 0, 16}};
static const DanaTypeField function_IOUDPLib_bind_fields[] = {
{(DanaType*) &int_def, NULL, 0, 0, 0},{(DanaType*) &char_array_def, NULL, 0, 0, 8},
{(DanaType*) &int_def, NULL, 0, 0, 48}};
static const DanaTypeField function_IOUDPLib_unbind_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &int_def, NULL, 0, 0, 0}};
static const DanaType object_IOUDPLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_IOUDPLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_IOUDPLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_IOUDPLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_IOUDPLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 96, (DanaTypeField*) &function_IOUDPLib_send_fields, 4},
{TYPE_FUNCTION, 0, 56, (DanaTypeField*) &function_IOUDPLib_recv_fields, 3},
{TYPE_FUNCTION, 0, 56, (DanaTypeField*) &function_IOUDPLib_bind_fields, 3},
{TYPE_FUNCTION, 0, 8, (DanaTypeField*) &function_IOUDPLib_unbind_fields, 2}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_IOUDPLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_IOUDPLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_IOUDPLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_IOUDPLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_IOUDPLib_functions_spec[4], "send", 4},
{(DanaType*) &object_IOUDPLib_functions_spec[5], "recv", 4},
{(DanaType*) &object_IOUDPLib_functions_spec[6], "bind", 4},
{(DanaType*) &object_IOUDPLib_functions_spec[7], "unbind", 6}};
static const DanaType IOUDPLib_object_spec[] = {
{TYPE_DATA, 0, 0, (DanaTypeField*) intf_functions_def, 8},
{TYPE_DATA, 0, 0, NULL, 0},
{TYPE_DATA, 0, 0, NULL, 0}
};
static const DanaTypeField intf_def[] = {
{(DanaType*) &IOUDPLib_object_spec[0], ".functions", 10},
{(DanaType*) &IOUDPLib_object_spec[1], ".events", 7},
{(DanaType*) &IOUDPLib_object_spec[2], ".state", 6},
};
...
static InterfaceDetails ids[] = {{"IOUDPLib", 8, &libType}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[3];
...
((VFrameHeader*) op_send_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[4];
...
((VFrameHeader*) op_recv_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[5];
...
((VFrameHeader*) op_bind_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[6];
...
((VFrameHeader*) op_unbind_thread_spec) -> localsDef = (size_t) &object_IOUDPLib_functions_spec[7];
