...
static const DanaTypeField function_CalendarLib_clone_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_CalendarLib_equals_fields[] = {
{(DanaType*) &bool_def, NULL, 0, 0, 0},{(DanaType*) &Object_def, NULL, 0, 1, 8}};
static const DanaTypeField function_CalendarLib_toString_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_CalendarLib_getID_fields[] = {
{(DanaType*) &char_array_def, NULL, 0, 0, 0}};
static const DanaTypeField function_CalendarLib_getLocalTime_fields[] = {
{(DanaType*) &void_def, NULL, 0, 0, 0},{(DanaType*) &DateTime_def, NULL, 0, 0, 0}};
static const DanaType object_CalendarLib_functions_spec[] = {
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_CalendarLib_clone_fields, 2},
{TYPE_FUNCTION, 0, 48, (DanaTypeField*) &function_CalendarLib_equals_fields, 2},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_CalendarLib_toString_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_CalendarLib_getID_fields, 1},
{TYPE_FUNCTION, 0, 40, (DanaTypeField*) &function_CalendarLib_getLocalTime_fields, 2}};
static const DanaTypeField intf_functions_def[] = {
{(DanaType*) &object_CalendarLib_functions_spec[0], "clone", 5},
{(DanaType*) &object_CalendarLib_functions_spec[1], "equals", 6},
{(DanaType*) &object_CalendarLib_functions_spec[2], "toString", 8},
{(DanaType*) &object_CalendarLib_functions_spec[3], "getID", 5},
{(DanaType*) &object_CalendarLib_functions_spec[4], "getLocalTime", 12}};
static const DanaType CalendarLib_object_spec[] = {
{TYPE_DATA, 0, 0, (DanaTypeField*) intf_functions_def, 5},
{TYPE_DATA, 0, 0, NULL, 0},
{TYPE_DATA, 0, 0, NULL, 0}
};
static const DanaTypeField intf_def[] = {
{(DanaType*) &CalendarLib_object_spec[0], ".functions", 10},
{(DanaType*) &CalendarLib_object_spec[1], ".events", 7},
{(DanaType*) &CalendarLib_object_spec[2], ".state", 6},
};
...
static InterfaceDetails ids[] = {{"CalendarLib", 11, &libType}};
...
((VFrameHeader*) op_clone_thread_spec) -> localsDef = (size_t) &object_CalendarLib_functions_spec[0];
...
((VFrameHeader*) op_equals_thread_spec) -> localsDef = (size_t) &object_CalendarLib_functions_spec[1];
...
((VFrameHeader*) op_toString_thread_spec) -> localsDef = (size_t) &object_CalendarLib_functions_spec[2];
...
((VFrameHeader*) op_getID_thread_spec) -> localsDef = (size_t) &object_CalendarLib_functions_spec[3];
...
((VFrameHeader*) op_getLocalTime_thread_spec) -> localsDef = (size_t) &object_CalendarLib_functions_spec[4];
