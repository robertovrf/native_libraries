...
((VFrameHeader*) op_pow_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + powLocalsDef.size;
((VFrameHeader*) op_pow_thread_spec) -> formalParamsCount = (powLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_pow_thread_spec)[1])[0] = (size_t) &powLocalsDef;
((VFrameHeader*) op_pow_thread_spec) -> functionName = "pow";
((VFrameHeader*) op_root_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + rootLocalsDef.size;
((VFrameHeader*) op_root_thread_spec) -> formalParamsCount = (rootLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_root_thread_spec)[1])[0] = (size_t) &rootLocalsDef;
((VFrameHeader*) op_root_thread_spec) -> functionName = "root";
((VFrameHeader*) op_log_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + logLocalsDef.size;
((VFrameHeader*) op_log_thread_spec) -> formalParamsCount = (logLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_log_thread_spec)[1])[0] = (size_t) &logLocalsDef;
((VFrameHeader*) op_log_thread_spec) -> functionName = "log";
((VFrameHeader*) op_natlog_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + natlogLocalsDef.size;
((VFrameHeader*) op_natlog_thread_spec) -> formalParamsCount = (natlogLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_natlog_thread_spec)[1])[0] = (size_t) &natlogLocalsDef;
((VFrameHeader*) op_natlog_thread_spec) -> functionName = "natlog";
((VFrameHeader*) op_natexp_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + natexpLocalsDef.size;
((VFrameHeader*) op_natexp_thread_spec) -> formalParamsCount = (natexpLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_natexp_thread_spec)[1])[0] = (size_t) &natexpLocalsDef;
((VFrameHeader*) op_natexp_thread_spec) -> functionName = "natexp";
((VFrameHeader*) op_cos_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + cosLocalsDef.size;
((VFrameHeader*) op_cos_thread_spec) -> formalParamsCount = (cosLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_cos_thread_spec)[1])[0] = (size_t) &cosLocalsDef;
((VFrameHeader*) op_cos_thread_spec) -> functionName = "cos";
((VFrameHeader*) op_sin_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + sinLocalsDef.size;
((VFrameHeader*) op_sin_thread_spec) -> formalParamsCount = (sinLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_sin_thread_spec)[1])[0] = (size_t) &sinLocalsDef;
((VFrameHeader*) op_sin_thread_spec) -> functionName = "sin";
((VFrameHeader*) op_tan_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + tanLocalsDef.size;
((VFrameHeader*) op_tan_thread_spec) -> formalParamsCount = (tanLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_tan_thread_spec)[1])[0] = (size_t) &tanLocalsDef;
((VFrameHeader*) op_tan_thread_spec) -> functionName = "tan";
((VFrameHeader*) op_acos_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + acosLocalsDef.size;
((VFrameHeader*) op_acos_thread_spec) -> formalParamsCount = (acosLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_acos_thread_spec)[1])[0] = (size_t) &acosLocalsDef;
((VFrameHeader*) op_acos_thread_spec) -> functionName = "acos";
((VFrameHeader*) op_asin_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + asinLocalsDef.size;
((VFrameHeader*) op_asin_thread_spec) -> formalParamsCount = (asinLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_asin_thread_spec)[1])[0] = (size_t) &asinLocalsDef;
((VFrameHeader*) op_asin_thread_spec) -> functionName = "asin";
((VFrameHeader*) op_atan_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + atanLocalsDef.size;
((VFrameHeader*) op_atan_thread_spec) -> formalParamsCount = (atanLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_atan_thread_spec)[1])[0] = (size_t) &atanLocalsDef;
((VFrameHeader*) op_atan_thread_spec) -> functionName = "atan";
((VFrameHeader*) op_cosh_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + coshLocalsDef.size;
((VFrameHeader*) op_cosh_thread_spec) -> formalParamsCount = (coshLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_cosh_thread_spec)[1])[0] = (size_t) &coshLocalsDef;
((VFrameHeader*) op_cosh_thread_spec) -> functionName = "cosh";
((VFrameHeader*) op_sinh_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + sinhLocalsDef.size;
((VFrameHeader*) op_sinh_thread_spec) -> formalParamsCount = (sinhLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_sinh_thread_spec)[1])[0] = (size_t) &sinhLocalsDef;
((VFrameHeader*) op_sinh_thread_spec) -> functionName = "sinh";
((VFrameHeader*) op_tanh_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + tanhLocalsDef.size;
((VFrameHeader*) op_tanh_thread_spec) -> formalParamsCount = (tanhLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_tanh_thread_spec)[1])[0] = (size_t) &tanhLocalsDef;
((VFrameHeader*) op_tanh_thread_spec) -> functionName = "tanh";
((VFrameHeader*) op_acosh_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + acoshLocalsDef.size;
((VFrameHeader*) op_acosh_thread_spec) -> formalParamsCount = (acoshLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_acosh_thread_spec)[1])[0] = (size_t) &acoshLocalsDef;
((VFrameHeader*) op_acosh_thread_spec) -> functionName = "acosh";
((VFrameHeader*) op_asinh_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + asinhLocalsDef.size;
((VFrameHeader*) op_asinh_thread_spec) -> formalParamsCount = (asinhLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_asinh_thread_spec)[1])[0] = (size_t) &asinhLocalsDef;
((VFrameHeader*) op_asinh_thread_spec) -> functionName = "asinh";
((VFrameHeader*) op_atanh_thread_spec) -> frameSize = sizeof(VFrame) + sizeof(ScopeContainer) + sizeof(VVarR) + atanhLocalsDef.size;
((VFrameHeader*) op_atanh_thread_spec) -> formalParamsCount = (atanhLocalsDef.structure.vsize / sizeof(DanaType)) - 1;
((size_t*) &((VFrameHeader*) op_atanh_thread_spec)[1])[0] = (size_t) &atanhLocalsDef;
