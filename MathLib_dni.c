...
{TYPE_DECIMAL, X_FLAT, 0, sizeof(size_t)*2, sizeof(size_t)*2, 0}};
static const StructuredType function_MathLib_sqrtDec_spec = {{NULL, NULL, 0, 0}, {(unsigned char*) function_MathLib_sqrtDec_def, NULL, 0, sizeof(function_MathLib_sqrtDec_def)}, 0};
